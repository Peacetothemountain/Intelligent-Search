...
**Developer / Owner:** NG Designs  
**Application:** Intelligent Search  

---

## 1. Overview & Commitment to User Privacy
NG Designs is committed to strict privacy protections for both the **Intelligent Search** application and the underlying repository codebase. Intelligent Search operates on an **On-Device First Privacy Architecture**.
...
- **Proprietary Software**: The repository, source code, build scripts, and visual assets are proprietary intellectual property of NG Designs.
...
- **No Marketing & No Third-Party Sharing**: NG Designs will **never** send promotional marketing emails, newsletters, or advertisements. Email addresses are never sold, rented, shared, or transferred to any third party.

## 6. Contact Information
For any questions regarding privacy governance or security protocols, please contact:  
**NG Designs Support**: [support.ngdesigns@gmail.com](mailto:support.ngdesigns@gmail.com)
